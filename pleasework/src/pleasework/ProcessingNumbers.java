...
public class ProcessingNumbers {
	...
	public static void main(String[] args) {
		...
		System.out.println("Print a random number here, just nothing below -120 cause it will crash. Don't panic, it will not be calculated.");
		int max = num.nextInt(); // Max number out of the numbers given by user input
